...
- Shorten and simplify the meaning as much possible, ideally into 1 sentence and at most 3, with more complex meanings being allowed more sentences.
    ...
    if (
        ...
        if jp_dict_entry:
            ...
            new_jp_meaning, new_en_meaning = get_single_meaning_from_model(
                config, word, sentences, jp_dict_entry, en_dict_entry
            )
